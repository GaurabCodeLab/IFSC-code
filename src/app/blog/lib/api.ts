...
import PaytmPaymentBank from '@/components/blogs/PaytmPaymentBank';
...
type BlogContent =
  ...
  | { type: 'paytmpaymentbank'; content: any };
...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'Learn about Paytm Payment Bank services, latest RBI updates, IFSC codes, and how to use digital wallet features like adding money and checking balance.',
    coverImage:
      'https://res.cloudinary.com/dqquvmo2p/image/upload/v1746735382/msid-107958388_width-1200_height-900_resizemode-4_kipkp8.jpg',
    coverImage2:
      'https://res.cloudinary.com/dqquvmo2p/image/upload/v1746735382/msid-107958388_width-1200_height-900_resizemode-4_kipkp8.jpg',
    keywords:
      'paytm payment bank, rbi paytm payments bank, paytm payment bank news, paytm payment bank ifsc code, paytm payment bank open account, is paytm payments bank working, how to add money in paytm wallet, how to earn paytm cash, how to check balance in paytm',
    content: [
      {
        type: 'paytmpaymentbank',
        content: PaytmPaymentBank,
      },
    ],
  },
