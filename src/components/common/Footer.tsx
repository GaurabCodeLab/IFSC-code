...
export default function SiteFooter() {
  ...
  return (
    <footer className="bg-gray-800 text-white pt-6 pb-2">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">BankInfo Hub</h3>
        ...
        <div className="border-t border-gray-700 mt-8 pt-3">
          <div className="flex flex-col-reverse justify-between items-center gap-3">
            <p className="text-sm text-gray-400">
              © {currentYear} BankInfo Hub. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0">
              <p className="text-xs text-gray-400">
                Disclaimer: We strive to provide the most accurate and
                up-to-date information available from the RBI. However, users
